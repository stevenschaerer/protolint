...
func TestExternalConfig_ShouldSkipRule(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			externalConfig:   noDefaultExternalConfig,
			inputRuleID:      "FIELD_NAMES_LOWER_SNAKE_CASE",
			inputDisplayPath: "some/other/dir/bar.proto",
			wantSkipRule:     true,
		},
		{
			...
			externalConfig:   noDefaultExternalConfig,
			inputRuleID:      "FIELD_NAMES_LOWER_SNAKE_CASE",
			inputDisplayPath: "/some/other/dir2/bar.proto",
			wantSkipRule:     true,
		},
		{
			...
			externalConfig:   noDefaultExternalConfig,
			inputRuleID:      "FIELD_NAMES_LOWER_SNAKE_CASE",
			inputDisplayPath: "/some/other/dir2/child/bar.proto",
			wantSkipRule:     true,
		},
		{
			name:                        "pattern exclude the matched windows directory",
			externalConfig:              noDefaultExternalConfig,
			inputRuleID:                 "FIELD_NAMES_LOWER_SNAKE_CASE",
			inputDisplayPath:            `\some\other\dir_windows\foo.proto`,
			inputIsWindowsPathSeparator: true,
			wantSkipRule:                true,
		},
		{
			name:                        "pattern exclude the matched windows directory by referring to an unix filepath",
			externalConfig:              noDefaultExternalConfig,
			inputRuleID:                 "FIELD_NAMES_LOWER_SNAKE_CASE",
			inputDisplayPath:            `\some\other\dir2\child\bar.proto`,
			inputIsWindowsPathSeparator: true,
